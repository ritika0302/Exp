		...
		<div class="wrap about-wrap eb-about-wrap">
			...
			<div class="changelog">
				...
				<p class="eb_welcome_mdl_dwnld_btn_wrap">
					<a class="eb_welcome_mdl_dwnld_btn" href="https://edwiser.org/wp-content/uploads/edd/2022/12/edwiserbridge.zip"> <?php echo esc_html__( 'Download Moodle Plugin', 'edwiser-bridge' ); ?> </a>
				</p>
